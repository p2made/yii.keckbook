...
<head>
    ...
    <meta name="csrf-token" content="OUV1N3N5N2xNNgVlRxAGBRR0R2E9Gn0ge3ETGjE.YQBNLyJ6KTpaBA==">
	<title>My Yii Application | yii.keckbook</title>
	<link href="//maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css" rel="stylesheet">
<link href="//maxcdn.bootstrapcdn.com/font-awesome/4.5.0/css/font-awesome.min.css" rel="stylesheet">
<link href="/assets/aee17f20/css/keckbook.css" rel="stylesheet">
</head>
<body>
...
<span class="icon-bar"></span>
<span class="icon-bar"></span></button><a class="navbar-brand" href="/">yii.keckbook</a></div>
				<div id="w0-collapse" class="collapse navbar-collapse"><ul id="w1" class="navbar-nav navbar-right nav"><li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Pages <b class="caret"></b></a><ul id="w2" class="dropdown-menu"><li><a href="/site/contact.p2m" tabindex="-1">Contact</a></li>
<li role="presentation" class="divider"></li>
<li><a href="/site/page.p2m?view=is-gd" tabindex="-1">is.gd Demo</a></li>
<li><a href="/site/page.p2m?view=uuid" tabindex="-1">UUID Demo</a></li>
<li><a href="/site/page.p2m?view=blank" tabindex="-1">Blank Page</a></li></ul></li>
<li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Ends <b class="caret"></b></a><ul id="w3" class="dropdown-menu"><li><a href="//hq.keckbook.yii.dev" tabindex="-1">Back End</a></li></ul></li>
<li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">Developer <b class="caret"></b></a><ul id="w4" class="dropdown-menu"><li><a href="/gii.p2m" tabindex="-1">Gii</a></li>
<li><a href="/debug.p2m" tabindex="-1">Debug</a></li></ul></li>
<li class="dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown">pedro <b class="caret"></b></a><ul id="w5" class="dropdown-menu"><li><a href="/profile/view.p2m" tabindex="-1">Profile</a></li>
<li><a href="/site/logout.p2m" data-method="post" tabindex="-1">Logout</a></li></ul></li></ul></div></div></nav>
		<div class="container">
	...
	<footer class="footer">
		<div class="container">
			<p class="pull-left">&copy; p2made 2016</p>
			<p class="pull-right">Powered by <a href="http://www.yiiframework.com/" rel="external">Yii Framework</a></p>
		</div>
	</footer>

<div id="yii-debug-toolbar" data-url="/debug/default/toolbar.p2m?tag=56fab76eabf31" style="display:none" class="yii-debug-toolbar-bottom">
</div>
<style>
...
<script src="/assets/ee7434e9/yii.js"></script>
